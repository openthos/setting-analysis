...
|时间节点|任务|
|---|---|
|2016.11.01-2016.11.30|1.[feature]应用的运行模式<br />2.[feature]桌面输入中文时与焦点依托<br />3.[feature]防火墙功能<br />4.解决第一次启动配置存在的bug<br />5.解决ota升级存在的bug<br />6.根据测试提供的优先级高的bug进行fix|
